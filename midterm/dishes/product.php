...
<?php if (isset($dishes)):?>
            <?php if($result):?>
                ...
                <?php if($dishesCheck > 0):
                    ...
                    ?>
                    <div class="container">
                        <div class="px-3 py-2 my-3 bg-dark-subtle rounded-3 d-flex justify-content-between align-items-center">
                            <h1>菜單管理</h1>
                            <div>
                                <a class="btn btn-sm btn-outline-success mx-1" href="../index.php">返回主頁</a>
                    ...
                    <div class="container">
                        <table class="table table-info table-striped table-hover border text-center align-middle ">
                            <thead>
                                <tr>
