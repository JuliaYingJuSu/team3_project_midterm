                                        ...
                                        <div class="row">
                                            <div class=" border bg-white rounded-3 col-7 p-4">
                                                ...
                                                <div class="d-flex flex-column">
                                                    ...
                                                    <input class="my-3 rounded" type="text" id="phone" name="phone" value="<?=($row['restaurant_phonenumber'])?$row['restaurant_phonenumber'] : ''?>">
                                                    <!-- 三元運算子是空值直接是空字串，不是就是電話 -->
                                                </div>
                                                <div class="d-flex flex-column">
                                                    <label class="fs-3" for="address">地址:</label>
                                                    <input class="my-3 rounded" type="text" id="address" name="address" value="<?=$row['restaurant_address']?>">
                                                </div>
                                                <div class="d-flex flex-column">
