...
<html lang="en">
    ...
    <body>
                    ...
                    <ul class="pagination">
                        <?php for($i=1;$i<=$totalPage;$i++): ?>
                            <li class="page-item">
                             ...
                             href="../utilities/navbar.php?webpage=post_ArticleList.php&page=<?=$i?><?=($search=="")?"":"&search=$search&qtype=$searchType"?>"><?=$i?></a>
                            </li>
                        <?php endfor; ?>
                    </ul>
                </div>
        ...
        <script>
            ...
            window.location.href = `../utilites/navbar.php?webpage=post_Articlelist.php&search=${query}&qtype=${queryType}`;
            })
        </script>
    </body>
</html>