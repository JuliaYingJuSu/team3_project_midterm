...
$fileIDs = explode(",", $row2["product_img_id"]);
...
$files = explode(",", $row2["product_img"]);
  ...
  <div class="container my-3">
    ...
    <form action="./doUpdate.php" method="post" enctype="multipart/form-data">
      ...
      <div class="input-group mb-1">
          ...
          <input name="name" type="text" class="form-control" placeholder="輸入產品名稱" value="<?=$row["product_name"]?>">
        </div>
    ...
    <div class="product">
      <?php foreach($files as $index => $file): ?>
        <img class="pimg delImg" src="./img/<?=$file?>" pid="<?=$id?>" idn="<?=$fileIDs[$index]?>" alt="">
