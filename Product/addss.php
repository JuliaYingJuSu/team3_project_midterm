...
<html lang="en">
    ...
    <body>
        <div class="container mt-3">
            <form action="./doAddss.php" method="post" enctype="multipart/form-data">
        ...
        <!-- 一檔多圖 -->
        <div class="input-group mt-2">
            <form id="form2" class="mt-5 p-2 bg-primary-subtle" method="post" action="../msg/doAddImg.php" enctype="multipart/form-data">
                <div class="contentArea">
                <!-- add start -->
                    <div class="input-group mt-1">
                ...
                <div class="mt-1 text-end">
                    ...
                    <button class="btn btn-warning btn-Img">增加一組</button>
                </div>
            </form>
            ...
            <div class="mt-1 text-end">
                ...
                <button class="btn btn-danger btn-add ">增加一組</button>
            </div>
        </form>
    </div>
<template id="inputs">
    ...
    <div class="input-group mt-1">
        ...
        <div class="input-group mt-2">
            <form id="form2" class="mt-5 p-2 bg-primary-subtle" method="post" action="../msg/doAddImg.php" enctype="multipart/form-data">
                ...
                <div class="mt-1 text-end">
                    <button type="submit" class="btn btn-info btn-save">寫入 img 資料庫</button>
                    <button class="btn btn-primary btn-Img">增加一組</button>
                </div>
            </form>
            <img src="../img/<?=$row["img"]?>" alt="" class="img">
