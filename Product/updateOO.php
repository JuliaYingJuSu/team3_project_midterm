...
<body>
    <div class="container mt-3">
        ...
        <form action="./doUpdateOO.php" method="post" enctype="multipart/form-data">
        ...
        <div class="d-flex">
            <?php foreach($row4s as $row4): ?>
                <div class="border border-secondary rounded p-1 m-2">
                    <img src="./img/<?=$row4["product_img"]?>" alt=""      
        ...
        <form id="form2" class="mt-2 mb-5 p-2 bg-primary-subtle" method="post" action="./doAddImg.php?id=<?=$id?>" enctype="multipart/form-data">
            <div class="myFiles">
                <div class="input-group mt-1">
            ...
            <div class="mt-1 text-start">
                ...
                <!-- <a class="btn btn-info" href="./doUpdateImg.php?id=<?=$id?>">修改</a> -->
                <a class="btn btn-info" href="">取消</a>
                <!-- ./list.php -->
            </div>
        </form>
