...
// $sql2 = "SELECT 
//   product_img.*, 
//   GROUP_CONCAT(DISTINCT product_img.product_img_id) as imgIDs,
//   FROM 
//   product_img
//   LEFT JOIN 
//   product ON product.product_id = product_img.product_id
//   WHERE 
...
// $imgIDs = explode(",", $row2s["product_img_id"]);
    ...
    <div class="container mt-3">
        ...
        <form action="./doUpdate.php" method="post" enctype="multipart/form-data">
            ...
            <div class="mt-1 text-end">
                <a href="./doAddImg.php?" class="btn btn-warning btn-sm" >新增圖片</a>
            </div> -->
            
        </form>
        
        <form id="form2" class="mt-2 p-2 bg-primary-subtle" method="post" action="./doAddImg.php?id=<?=$id?>" enctype="multipart/form-data">
            <div class="myFiles">
                <div class="input-group mt-1">
