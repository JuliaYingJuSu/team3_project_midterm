...
for($i=0;$i<$count;$i++){
  // 取出寫成資料庫內容時將標籤<>等轉為文字格式
    ...
    $img = $imgValues[$i];
    $sql.=
    "INSERT INTO `product` (`product_id`, `product_name`, `price`, `product_img`,  `product_description`, `specification`, `discount_rate`, `product_type_id`, `product_type_list_id`, `isValid`) VALUES (NULL, '$name', '$price', '$img', '$desc', '$spec', '1', '$type', '$typeList', '1');";
